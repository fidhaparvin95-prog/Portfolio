...
<body>
    ...
    <div class="container" style="margin-top: <?php if ($page == "boys") {
                                                    print("50px");
                                                } else {
                                                    print("90px");
                                                } ?>;">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="text-center" style="font-weight:bold;display:<?php if ($page == "boys") {
                ...
                <div class="col-md-4" style="height:650px;">
                    <div class="card" style="width: auto;height: auto;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="margin:auto;color:black;background:none;border:none;font-size: 1.2rem;text-decoration:underline;display:<?php if ($page == "boys") {
                            ...
                            <br>
                            <form name="feedback" method="get" action="feedback.php#<?php print($row['product id']); ?>" style="display: <?php if ($page == "boys") {
    ...
    <!-- End of Boys Product display -->
    <?php
    mysqli_close($conn);
    ?>
    <!--Start of Footer -->
    <footer>
        <div class="<?php if ($page == "boys") {
