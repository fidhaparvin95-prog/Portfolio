...
<body>
    ...
    <div class="container" style="margin-top: <?php if ($page == "girls") {
                                                    print("50px");
                                                } else {
                                                    print("90px");
                                                } ?>;">
        <div class="row">
            <div class="col-md-12">
                ...
                <h4 class="text-center" style="font-weight:bold;display:<?php if ($page == "girls") {
                ...
                <div class="col-md-4" style="height:650px;">
                    <div class="card" style="width: auto;height: auto;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" style="margin:auto;color:black;background:none;border:none;font-size: 1.2rem;text-decoration:underline;display:<?php if ($page == "girls") {
                            ...
                            <br>
                            <form name="feedback" method="get" action="feedback.php#<?php print($row['product id']); ?>" style="display: <?php if ($page == "girls") {
    ...
    <!--Start of Footer -->
    <footer>
        <div class="<?php if ($page == "girls") {
                        // Fixed footer if user not logged in
                        print("fixedfooter");
                    } else {
                        // Footer if user logged in
                        print("footer");
                    } ?>">
